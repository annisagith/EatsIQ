...
<body class="bg-gray-400 shadow text-black flex flex-col min-h-screen">
    ...
    <div class=" mx-auto mt-10">
        ...
        <div
            class="grid grid-cols-3 gap-x-14 gap-y-7 mx-auto lg:grid-cols-3 xl:grid-cols-3 lg:gap-x-32 xl:gap-x-32 lg:gap-y-20  ">
        ...
        async function updateCircles() {
            ...
            if (data) {
                const circle = document.getElementById(
                    `circle-1`); // Assume the latest data is for circle 1 for example
                if (circle) {
                    if (data.indikator == 1) {
